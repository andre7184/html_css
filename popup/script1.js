...
const popup = new Popup({fecharComEsc: true});
...
function criarPopup() {
    ...
    popup.showPopup(body, titulo, 'azul', () => {
...
const botao = document.getElementById("btnPopup");
botao.addEventListener("click", criarPopup);
